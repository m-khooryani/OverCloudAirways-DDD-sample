...
public class TestFixture : IDisposable
{
    ...
    private readonly string _databaseId = "CrmDBTest_" + Guid.NewGuid().ToString()[..6];
    ...
    private void SetupCompositionRoot(
        ...
        string? accountKey)
    {
        var domainAssembly = Assembly.Load("OverCloudAirways.CrmService.Domain");
        var infrastructureAssembly = Assembly.Load("OverCloudAirways.CrmService.Infrastructure");
        var applicationAssembly = Assembly.Load("OverCloudAirways.CrmService.Application");
